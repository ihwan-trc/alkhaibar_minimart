      ...
      <form id="formTambah" action="<?php echo base_url('gudang/simpan_barang') ?>" method="post">
        <table border="0" class="table" align="center">
          ...
          <tr>
            ...
            <td>:</td>
            <td>
                <select name="kd_supplier" id="kd_supplier" class="span6" required>
          ...
          <tr>
            <td>Harga Jual<font color="red" size="1px"><br>*Lebih besar dari HPP</font></td>
            <td>:</td>
            <td><input type="text" name="hrg_jual" id="hrg_jual" required /></td>
          </tr>
          <!-- <tr>
            <td>Bahan Untuk <font color="red">(Disable)</font></td>
            <td>:</td>
      ...
      $('#tbBarang').DataTable({
        ...
        "serverSide": true,
            ...
            "columns": [
                ...
                {"data": "hrg_jual",render: $.fn.dataTable.render.number( '.', '.', 0 )},
                {"data": "Aksi"},
            ],
        });
