            ...
            <table cellspacing="0">
              ...
              <tbody>
                  <tr>
                    ...
                    <td><input type="text" style="width: 13em" name="nm_supplier" id="nm_supplier" class="form-control" readonly></td>
        ...
        $.ajax({
            ...
            success: function(data){
                $.each(data,function(namaproduk){
                    ...
                    $('[name="nm_supplier"]').val(data.supplier);
    ...
    $('#btn_add_list').on('click',function(e){
        ...
        var satuan=$('#satuan').val();
            $.ajax({
                ...
                dataType : "JSON",
                data : {idbarang: idbarang, nm_barang:nm_barang, nm_supplier:nm_supplier, nofaktur:nofaktur, jumlah:jumlah, harga_beli:harga_beli,satuan:satuan},
                success: function(data){
                    $('[name="idbarang"]').val("");
                    $('[name="nm_barang"]').val("");
                    $('[name="nm_kategori"]').val("");
              ...
              success : function(data){
                  ...
                  for(i=0; i<data.length; i++){
                      html += '<tr>'+
                          ...
                          html += '<tr>'+
                                  '<th colspan="5" style="text-align:center; font-size : 14px;">Total</th>'+
