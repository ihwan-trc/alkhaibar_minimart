            ...
            <div class="panel-body">
              ...
              <div>
                <div class="form-inline">
                  ...
                  <br><br>
                  <input style="text-align: right;" type="hidden" class="form-control pull-left" id="debet" placeholder="Debet (Rp)" name="debet">
                  <input type="hidden" class="form-control pull-right" id="bank" placeholder="Bank" name="bank">
                <br><br>
                <button id="btnHitung" class="btn btn-success pull-right"><font color="red">Hitung</font></button>
